...
describe('LoginForm', () => {
  ...
  it('toggles password visibility', async () => {
    ...
    const passwordInput = screen.getByLabelText(/Dashboard Password/i) as HTMLInputElement;
    // The toggle button has tabIndex={-1} and no accessible name, query by role within the form
  ...
  it('shows validation error on form submit with empty password', async () => {
    renderWithProviders(<LoginForm onSuccess={mockOnSuccess} />);
