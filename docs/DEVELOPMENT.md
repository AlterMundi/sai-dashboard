...
DATABASE_URL=postgresql://n8n_user:a5sd87akdVDS5@localhost:5432/n8n
DB_HOST=localhost
DB_PORT=5432
DB_NAME=n8n
DB_USER=n8n_user
DB_PASSWORD=a5sd87akdVDS5
...
services:
  sai-dashboard-backend:
    ...
    environment:
      - NODE_ENV=production
      - DATABASE_URL=postgresql://n8n_user:a5sd87akdVDS5@host.docker.internal:5432/n8n
      - API_PORT=3001
    depends_on:
      - postgres
  ...
  postgres:
    ...
    environment:
      ...
      - POSTGRES_PASSWORD=a5sd87akdVDS5
    ports:
      - "5432:5432"
    volumes:
